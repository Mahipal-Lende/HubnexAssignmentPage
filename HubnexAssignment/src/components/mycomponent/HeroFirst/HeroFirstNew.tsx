      ...
      <div className="flex flex-wrap w-full px-4 my-4 items-center">
        ...
        <div className="w-full lg:w-2/5 flex justify-center lg:mt-0 mt-10">
          <div className="rounded-2xl overflow-hidden min-h-[300px] lg:min-h-[500px] lg:min-w-[500px] mt-20">
            <img
              src="https://s3-alpha-sig.figma.com/img/3459/1306/8b659eea92f8fac3c8bacae4f562ea37?Expires=1733097600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=N-z5Cnhyuc~xHlB6HmV69O6bjSwRle1tDRwxafvTlNF88nvTL-QzeJWVXV2VE9NyyXTBetsAjF0WuPzc7OvVJ1BdvxB9nrY1LCnKCfQYbDjF0yjVIVLHXy2HmM64EhMf6CbpNZoi3-Mskn2hzUkp6DrxnquXD5FZ2loQN7nvYl71tyQ1oT2dZ6IkvkCxPCr7fGgXefEQdjDVuvkqnnjctQpjNupKiKWbbcnzrDI~Spop-NGMNr978rCjfPL7KY0vB1cEiMXj9HWCLZN4Nu5vYm8s3ZMT89N-jWltfQfrXRxTNzpYFJ4V~7V0ee9KA6T7kLZ3pCu6klwRxHY53ppajw__"
              alt="Hero Image"
